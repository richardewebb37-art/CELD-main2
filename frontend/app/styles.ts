...
import { scale, SCREEN_WIDTH, SCREEN_HEIGHT } from './utils';
...
export const styles = StyleSheet.create({
  ...
  recapTitle: { color: '#60a5fa', fontWeight: 'bold', marginBottom: scale(16), fontSize: 14 },
  recapDaysContainer: { flexDirection: 'row', justifyContent: 'space-between', gap: scale(8) },
  recapDayCard: { flex: 1, backgroundColor: '#0f172a', padding: scale(12), borderRadius: scale(8), alignItems: 'center', borderWidth: 1, borderColor: '#334155' },
  recapDayDate: { color: '#94a3b8', marginBottom: scale(4), fontWeight: '600' },
  recapDayTime: { color: '#10b981', fontWeight: 'bold', fontFamily: Platform.OS === 'ios' ? 'Courier' : 'monospace' },
  ...
  verifyButton: { backgroundColor: '#10b981', padding: scale(12), borderRadius: scale(8), marginBottom: scale(16), alignItems: 'center' },
  ...
  logGraphLabels: { marginTop: scale(16) },
